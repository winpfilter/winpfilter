...
#define IPV4_HEADER_SRC_ADDR(header)						(CONVERT_NETE_32((header)->SrcAddress))
#define IPV4_HEADER_DEST_ADDR(header)						(CONVERT_NETE_32((header)->DestAddress))
...
#define SET_IPV4_HEADER_SRC_ADDR(header,src_addr)			((header)->SrcAddress = CONVERT_NETE_32(src_addr))
#define SET_IPV4_HEADER_DEST_ADDR(header,dest_addr)			((header)->DestAddress = CONVERT_NETE_32(dest_addr))
