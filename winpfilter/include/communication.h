...
#define WINPFILTER_CTL_CODE_RT_TABLE_INFO	CTL_CODE(FILE_DEVICE_UNKNOWN,0x809, METHOD_BUFFERED,FILE_ALL_ACCESS)
#define WINPFILTER_CTL_CODE_RT_TABLE_CTL	CTL_CODE(FILE_DEVICE_UNKNOWN,0x810, METHOD_BUFFERED,FILE_ALL_ACCESS)
